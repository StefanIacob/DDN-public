...
if __name__ == '__main__':
    ...
    net = populations.GMMPopulation(**net_params)
    ...
    # i_gen = 99
    # i_pop = 0
    # filename = "es_results/cma_es_gmm_230222k3_tanh_vd_reg.p"
    ...
    dir = 'es_results'
    name = 'cma_es_gmm_010422_k1_tanh_final_paper_bl'
    print('dt', dt)
    print('B', buffersize)
    print('Regularization', alphas)
    print('k', k)
    evolution.cmaes_alg_gma_pop(net, data_train, data_val, max_it, pop_size, std=std, dir=dir, name=name, alphas=alphas)
