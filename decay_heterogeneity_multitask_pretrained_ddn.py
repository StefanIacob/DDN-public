...
if __name__ == '__main__':
    ...
    # Load earlier DDN run
    dirname ='heterogeneity_results'
    filename = '2024-10-22_multi_task_exp_weighed_DDN_fixed_decay_net_wide_4k.p'
    with open(os.path.join(dirname, filename), 'rb') as f:
        prev_run_dict = pkl.load(f)
    print(prev_run_dict.keys())
