...
def visualize_GMM_net(seed):
    mix = seed.mix
    mu_x = seed.mu_x
    mu_y = seed.mu_y
    var_x = seed.variance_x
    var_y = seed.variance_y
    corr_xy = seed.correlation
    k = seed.k
    conn = seed.connectivity
    x_range = seed.x_range
    y_range = seed.y_range
    mu_x_in, mu_y_in = seed.mu_in
